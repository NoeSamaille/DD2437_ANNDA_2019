...
Here you will create a Restricted Boltzmann Machine, implement the inference rules, and learn the parameters with contrastive divergence. You would have to work on the following functions :
...
Here you will implement the wake-sleep algorithm to fine-tune all the parameters of the DBN. You would also have to implement new RBM methods for learning directed connections. You would have to work on the following functions:
